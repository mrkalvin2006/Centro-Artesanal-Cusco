  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-mystic-black/100 via-mystic-black/80 to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-t from-mystic-dark via-transparent to-transparent opacity-100" />
      </motion.div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
        ...
        >
          <h1 className="font-serif text-5xl md:text-7xl text-white mb-4 leading-tight drop-shadow-2xl">
            ...
            <span
              className="text-mystic-gold text-6xl md:text-8xl"
      ...
      <div className="absolute bottom-10 right-10 z-20 gap-3 hidden md:flex">
        <button
          type="button"
          onClick={prevImage}
          className="w-12 h-12 rounded-full border border-white/20 bg-black/20 backdrop-blur flex items-center justify-center text-white hover:bg-mystic-gold hover:border-transparent transition-all"
        >
